package expression_tree.interpreter;
 ...
 *  Interpreter
 *
 *        Parses incoming expression strings into a parse tree and
...
public class Interpreter {
    ...
    private final ExpressionTreeFactory expressionTreeFactory;


    /**
     *  SymbolTable
     * 
     *  This class stores variables and their values for use by
     ...
     * create the appropriate subclass of @a Node.
     */
    ...
    private Stack<Symbol> insertNumberOrVariable(String input, int startIndex, Stack<Symbol> parseTree, boolean isVariable) {
        /** 
        ...
        if (isVariable)
            ...
            number = new Number(input.substring(startIndex, startIndex + endIndex));
    ...
    private Stack<Symbol> handleParentheses(String inputExpression, int index, boolean handled, Stack<Symbol> masterParseTree) {
        /** 
    ...
    abstract class Symbol {
        ...
        /** Abstract method for building a @a Node. */
        abstract Node build();
    }
     ...
     *  Negate
     *
     *  Defines a node in the parse tree for unary minus
     ...
     *  Add
     *
     *  Defines a node in the parse tree for the binary add
     *        operator non-terminal expression.
     */
     ...
     *  Divide
     *
     *  Defines a node in the parse tree for the binary divide
     *        operator non-terminal expression.
     */
