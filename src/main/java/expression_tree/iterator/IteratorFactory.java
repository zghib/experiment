package expression_tree.iterator;
 ...
 *  IteratorFactory
 * 
 *  Implementation of the Factory Method pattern that
...
public class IteratorFactory {
     ...
     * requested iterator. .
     */
    private HashMap<String, IIteratorFactoryCommand> traversalMap = new HashMap<String, IIteratorFactoryCommand>();
